...
import com.dist.canal.security.CustomAccessDeniedHandler;
import com.dist.canal.security.JwtAuthenticationEntryPoint;
import com.dist.canal.security.JwtAuthenticationFilter;
...
import static com.dist.canal.constant.Constants.PUBLIC_URLS;
        ...
        http
                ...
                .authorizeHttpRequests(request ->
                        request.requestMatchers(PUBLIC_URLS).permitAll()
                                ...
                                .requestMatchers(DELETE, "/auth/securecanal/delete/**")
                                .hasAnyAuthority("DELETE:USER")
                                .requestMatchers(DELETE, "/auth/securecanal/campaign/delete/**")
                                .hasAnyAuthority("DELETE:CANAL")
