...
import com.dist.canal.form.NewPasswordForm;
import com.dist.canal.form.SettingsForm;
import com.dist.canal.form.UpdateForm;
import com.dist.canal.form.UpdatePasswordForm;
import com.dist.canal.payload.*;
import com.dist.canal.security.JwtTokenProvider;
import com.dist.canal.service.AuthService;
...
import static com.dist.canal.constant.Constants.TOKEN_PREFIX;
import static com.dist.canal.enumeration.EventType.*;
import static com.dist.canal.utils.UserUtils.getAuthenticatedUser;
import static com.dist.canal.utils.UserUtils.getLoggedInUser;

@RestController
@RequestMapping("/auth/securecanal")
...
public class AuthController {
    ...
    private URI getUri() {
        return URI.create(fromCurrentContextPath().path("/auth/securecanal/get/<userId>").toUriString());
    }
